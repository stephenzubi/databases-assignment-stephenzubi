...
* populate the table with data in the atm_pressure.csv file. The table should include these features:
...
* produce a summary table detailing the sampling site and *average* barometric pressue for each sonde event. See [here](https://www.sqlite.org/lang_aggfunc.html) for details about aggregating functions in SQLite.
